...
// CONCATENATED MODULE: ./lib/mobx/stores/appStore.ts
...
let appStore_CounterStore = (_class = (_temp = class CounterStore {
  constructor() {
    _initializerDefineProperty(this, "number", _descriptor, this);

    _initializerDefineProperty(this, "increase", _descriptor2, this);

    _initializerDefineProperty(this, "decrease", _descriptor3, this);
  }

}, _temp), (_descriptor = _applyDecoratedDescriptor(_class.prototype, "number", [external_mobx_["observable"]], {
  configurable: true,
  enumerable: true,
  writable: true,
...
}), _descriptor2 = _applyDecoratedDescriptor(_class.prototype, "increase", [external_mobx_["action"]], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor3 = _applyDecoratedDescriptor(_class.prototype, "decrease", [external_mobx_["action"]], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
// CONCATENATED MODULE: ./lib/mobx/stores/index.tsx


const stores_isServer = "undefined" === 'undefined';
...
function initializeStore(initialData = {
  ...
  if (stores_isServer) {
    return {
      appStore: new appStore_CounterStore()
    };
  }
...
class _app_CustomApp extends app_default.a {
  ...
  render() {
    ...
    return external_react_default.a.createElement(external_mobx_react_["Provider"], this.mobxStore, external_react_default.a.createElement(app["Container"], null, external_react_default.a.createElement(Component, pageProps)));
  }
